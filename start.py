    ...
    client.send_message(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "🔥Updates🔥", url=f"https://t.me/TeamUltronX"
                    ),
                    InlineKeyboardButton(
                        "🔥Support🔥", url=f"https://t.me/TeamUltronX"
                    ),
                ],
                [InlineKeyboardButton("❤Owner❤", url=f"https://t.me/Officiallycute")],
            ]
        ),
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💬 Support Chat", url=f"https://t.me/TeamUltronX"
                    )
                ]
            ]
        ),
...
def map(pos):
    if pos == 1:
        ...
        button = [
            ...
            [
                InlineKeyboardButton(
                    text="🔥Updates🔥", url=f"https://t.me/TeamUltronX"
                ),
                InlineKeyboardButton(
                    text="🔥Support🔥", url=f"https://t.me/TeamUltronX"
                ),
            ],
            [
                InlineKeyboardButton(
                    text="❤Owner❤", url=f"https://t.me/officiallycute"
                )
            ],
